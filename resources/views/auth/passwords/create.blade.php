        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ URL::route('update_password', ['id' => $user->id]) }}">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        @if (count($errors) > 0)
            ...
            @endif
                        ...
                        <div class="form-group{{ $errors->has('access_token') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="access_token" type="text" class="form-control" name="access_token" required>
                            </div>
                        </div>
