...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form role="form" method="POST" action="{{ URL::route('create_substitute_teachers-super_administrator') }}">
            {{ csrf_field() }}
            <div class="form-group">
                <label for="schooldivision_id">School Divisions</label>
                <select name="schooldivision_id" class="form-control">
                    @foreach($schoolDivision as $schoolDivision)
